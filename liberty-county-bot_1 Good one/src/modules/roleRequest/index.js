...
async function handleModalSubmit(interaction) {
  ...
  webhookEngine
    .sendEvent(interaction.client, interaction.guildId, 'staff.role_request_created', {
      user: `<@${interaction.user.id}>`,
      department,
    ...
    .catch((err) => console.error('[webhookEngine] role_request_created failed:', err));
}
...
async function handleReviewButton(interaction) {
  ...
  webhookEngine
    .sendEvent(interaction.client, interaction.guildId, 'staff.role_request_decided', {
      request_id: id,
      decision: decision === 'approve' ? 'approved' : 'rejected',
      reviewer: `<@${interaction.user.id}>`,
    })
    .catch((err) => console.error('[webhookEngine] role_request_decided failed:', err));
}
...
module.exports = {
  ...
  requiredEmojis: ['staff.role_request'],
